                    ...
                    <tr key={z.id} onClick={() => setSelected(z)}
                      ...
                      <td className="px-5 py-4" onClick={e => e.stopPropagation()}>
                        {['В работе', 'Завершена', 'Отклонена'].includes(z.status) ? (
                          <span className="text-xs text-gray-400 italic">Нельзя изменить</span>
                        ) : (
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden sticky top-0">
            ...
            <div className="p-4 space-y-4 text-sm">
              ...
              <div>
                ...
                {['В работе', 'Завершена', 'Отклонена'].includes(selected.status) ? (
                  <div className="bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-xs text-gray-400 text-center italic">
